...
2. LANGUAGE: All textual fields (name, contractor, description) MUST be in Polish. Correct obvious OCR errors (e.g. 'kośoś' -> correct contextually appropriate item name based on context/price/brand, or standardize to clear text).
...
5. CONTRACTOR: Extract the actual vendor/store name (e.g., "Biedronka", "Lidl sp. z o.o.", "Żabka"). Do NOT use document headers like "PARAGON FISKALNY" as the contractor name.
...
- If OCR yields typos (e.g., 'Antipasti' -> 'Antipasto'), fix them to Polish standards unless it creates a hallucination.
...
- Look for VAT labels (A/B/C/D) but extract the gross amount at the end of the receipt.
